...
annotation {
    ...
    // Icon: reference to a blob element (PNG) in this same FS document.
    // Onshape only accepts blob element IDs here — base64/inline data
    // triggers "Icon must be a valid blob element."
    "Icon" : "93150c6d1bffffab7609190f"
}
