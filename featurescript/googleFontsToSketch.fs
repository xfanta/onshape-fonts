...
export const googleFontsToSketch = defineFeature(function(context is Context, id is Id, definition is map)
    precondition
    {
        ...
        {
            annotation {
                        "Name" : "Curve data (JSON)",
                        "Description" : "Serialized cubic-Bézier curves. Normally produced by the add-in's web panel — paste a JSON generated by /preview here to insert text without opening the panel."
                    }
