  ...
  return (
    <div className="flex items-center justify-between gap-2">
      ...
      <a
        ...
        className="flex items-center gap-1 text-xs text-gray-500 hover:text-[#ed3338]"
      >
        <svg viewBox="0 0 16 16" width="14" height="14" fill="currentColor" aria-hidden>
          <path d="M8 14.5s-5.5-3.5-5.5-7.5a3.5 3.5 0 0 1 6.5-1.8A3.5 3.5 0 0 1 13.5 7c0 4-5.5 7.5-5.5 7.5z" />
        </svg>
        <span>Donate</span>
      </a>
    </div>
