...
const LOGO_SIZE = 26;                                 // another 10 % step down from 29
...
const LOGO_GAP = 9;                                   // 10 → 9
const WORDMARK_FONT_SIZE = 16;                        // 18 → 16
const WORDMARK_APPROX_WIDTH = 188;                    // 'Google Fonts for Onshape' @ 16 px system semibold + regular
